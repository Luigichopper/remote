...
public class BlossomedCherryLeavesBlock extends LeavesBlock {
	public BlossomedCherryLeavesBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(EternalModItems.CHERRY.get()));
	}
}
