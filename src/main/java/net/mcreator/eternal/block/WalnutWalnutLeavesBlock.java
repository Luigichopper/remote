...
public class WalnutWalnutLeavesBlock extends LeavesBlock {
	public WalnutWalnutLeavesBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(EternalModItems.CLOSED_WALNUT.get(), 2));
	}
	...
	public static void blockColorLoad(RegisterColorHandlersEvent.Block event) {
		...
		}, EternalModBlocks.WALNUT_WALNUT_LEAVES.get());
	}
