...
public class IronBowItem extends Item {
	public IronBowItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(425));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					IronBowEntity entityarrow = IronBowEntity.shoot(world, entity, world.getRandom(), 1.1f, 5.5, 5);
