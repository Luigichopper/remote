...
public class LettucePlantStage0OnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
			...
			activeStage = EternalModBlocks.LETTUCE_PLANT_STAGE_0.get().defaultBlockState();
			nextStage1 = EternalModBlocks.LETTUCE_PLANT_STAGE_1.get().defaultBlockState();
			nextStage2 = EternalModBlocks.LETTUCE_PLANT_STAGE_2.get().defaultBlockState();
			random = Math.random();
