...
public class CherryForestLeaveDecorator extends LeaveVineDecorator {
	public static final CherryForestLeaveDecorator INSTANCE = new CherryForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("cherry_forest_tree_leave_decorator", tdt);
	}

	public CherryForestLeaveDecorator() {
		super(0.25f);
	}
