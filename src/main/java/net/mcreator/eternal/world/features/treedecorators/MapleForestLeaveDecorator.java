...
public class MapleForestLeaveDecorator extends LeaveVineDecorator {
	public static final MapleForestLeaveDecorator INSTANCE = new MapleForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("maple_forest_tree_leave_decorator", tdt);
	}

	public MapleForestLeaveDecorator() {
		super(0.25f);
	}
